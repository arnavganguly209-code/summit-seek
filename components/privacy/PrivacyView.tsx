    ...
    <div className="relative bg-[#f3f6fb]">
      ...
      <div className="relative mx-auto w-full max-w-[980px] px-5 py-12 sm:px-8 lg:px-10 lg:py-16">
        <section className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-3 font-[family-name:var(--font-display)] text-[1.75rem] font-bold tracking-[-0.02em] text-[#0b1524] sm:text-[2.2rem]">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="font-[family-name:var(--font-display)] text-[1.15rem] font-bold text-[#0b1524] sm:text-[1.28rem]">
                    {section.title}
                  </h3>
