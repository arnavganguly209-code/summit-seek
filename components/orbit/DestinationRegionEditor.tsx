...
export function DestinationRegionEditor({
  initial,
  title = "Destination Region",
  pathLabel = "/destinations",
  apiPath = "/api/orbit/everest-region",
  packageIdPrefix = "pkg",
  newPackageTitle = "New Trek",
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1.5 max-w-xl text-[14px] text-white/55">
            Full control of {pathLabel} — cover, intro, and the 2×2 package grid
