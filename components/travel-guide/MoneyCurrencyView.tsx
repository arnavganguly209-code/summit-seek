...
export function MoneyCurrencyView({ content }: { content: MoneyCurrencyContent }) {
      ...
      <div className="relative mx-auto w-full max-w-[1100px] px-5 py-12 sm:px-8 lg:px-10 lg:py-16">
        ...
        <section className="mt-10 rounded-[1.4rem] border border-[#e4eaf3] bg-white p-5 sm:p-8">
          <div className="flex items-center gap-2">
            <Banknote className="size-5 text-[#F58220]" />
            <h3 className="font-[family-name:var(--font-display)] text-[1.3rem] font-bold text-[#0b1524]">
              {content.currencyHeading}
            </h3>
          </div>
          <div className="mt-4 space-y-3">
            <Paras
              text={content.currencyBody}
