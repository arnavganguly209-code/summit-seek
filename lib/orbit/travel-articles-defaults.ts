...
export const DEFAULT_TRAVEL_ARTICLES: TravelArticlesContent = {
  eyebrow: "Stay Updated",
  heading: "Travel Articles",
  ...
  articles: [
    ...
    },
    {
      id: "ta-2",
      title:
        "Annapurna Base Camp Trek – Discover Nepal's Iconic Himalayan Adventure in 14 Days",
      dateLabel: "JULY 28, 2026",
      href: "/blog/annapurna-base-camp-trek-guide",
      imageUrl:
